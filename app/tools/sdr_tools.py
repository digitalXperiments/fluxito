...
# The exact markdown contract Claude must follow — single source of truth lives in
# app.tools.sdr_bootstrap.contract and is also embedded verbatim in the skill doc.
_SDR_MARKDOWN_SCHEMA = SDR_MARKDOWN_SCHEMA
